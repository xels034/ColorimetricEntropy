...
/*         Label_0022: {
    ...
    public enum Format
    {
        ALPHA("ALPHA", 0, 1, true), 
        LUMINANCE("LUMINANCE", 1, 1, false), 
        LUMINANCE_ALPHA("LUMINANCE_ALPHA", 2, 2, true), 
        RGB("RGB", 3, 3, false), 
        RGBA("RGBA", 4, 4, true), 
        BGRA("BGRA", 5, 4, true), 
        ABGR("ABGR", 6, 4, true);
        ...
        private Format(final String name, final int ordinal, final int numComponents, final boolean hasAlpha) {
